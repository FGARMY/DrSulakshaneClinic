    ...
    <section id="contact" className="section-padding bg-white relative">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          {/* Map */}
          <div className="lg:col-span-2 rounded-3xl overflow-hidden shadow-lg border border-slate-100 min-h-[400px] opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <iframe
          ...
          {/* Info Card */}
          <div className="glass-card-strong rounded-3xl p-8 flex flex-col justify-center gap-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
